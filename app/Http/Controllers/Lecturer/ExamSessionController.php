...
class ExamSessionController extends Controller
{
    ...
    public function index()
    {
        ...
        //render with inertia
        return inertia('Lecturer/ExamSessions/Index', [
    ...
    public function create()
    {
        ...
        //render with inertia
        return inertia('Lecturer/ExamSessions/Create', [
            'exams' => $exams,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        //redirect
        return redirect()->route('lecturer.exam_sessions.index');
    }
    ...
    public function show($id)
    {
        ...
        //render with inertia
        return inertia('Lecturer/ExamSessions/Show', [
    ...
    public function edit($id)
    {
        ...
        //render with inertia
        return inertia('Lecturer/ExamSessions/Edit', [
            'exam_session'  => $exam_session,
            'exams'         => $exams,
        ]);
    }
    ...
    public function createEnrolle(ExamSession $exam_session)
    {
        ...
        //render with inertia
        return inertia('Lecturer/ExamGroups/Create', [
            'exam'          => $exam,
            'exam_session'  => $exam_session,
            'students'      => $students,
        ]);
    ...
    public function storeEnrolle(Request $request, ExamSession $exam_session)
    {
        ...
        //redirect
        return redirect()->route('lecturer.exam_sessions.show', $exam_session->id);
    }
