    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/lecturer/dashboard') }">
                    <Link href="/lecturer/dashboard" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/lecturer/exams') }">
                    <Link href="/lecturer/exams" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/lecturer/exam_sessions') }">
                    <Link href="/lecturer/exam_sessions" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/lecturer/reports') }">
                    <Link href="/lecturer/reports" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
