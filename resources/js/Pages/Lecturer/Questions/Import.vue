<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link :href="`/lecturer/exams/${exam.id}`" class="btn btn-md btn-primary border-0 shadow mb-3 me-3" type="button"><i
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                //send data to server
                router.post(`/lecturer/exams/${props.exam.id}/questions/import`, {
                    //data
                    file: form.file,
                }, {
                    onSuccess: () => {
