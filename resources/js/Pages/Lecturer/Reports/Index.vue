                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-12">
                                <a :href="`/lecturer/reports/export?exam_id=${form.exam_id}`" target="_blank" class="btn btn-success btn-md border-0 shadow w-100 text-white"><i class="fa fa-file-excel"></i> DOWNLOAD EXCEL</a>
                            </div>
                        </div>
                        <hr>
    ...
    export default {
        ...
        setup() {
            ...
            const filter = () => {
                ...
                //HTTP request
                router.get('/lecturer/reports/filter', {
