    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <Link href="/lecturer/exams" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        ...
                        <Link :href="`/lecturer/exams/${exam.id}/questions/create`" class="btn btn-md btn-primary border-0 shadow me-2" type="button"><i class="fa fa-plus-circle"></i> Tambah</Link>
                        <Link :href="`/lecturer/exams/${exam.id}/questions/import`" class="btn btn-md btn-success border-0 shadow text-white" type="button"><i class="fa fa-file-excel"></i> Import</Link>
                                ...
                                <tbody>
                                    <tr v-for="(question, index) in exam.questions.data" :key="index">
                                        ...
                                        <td class="text-center">
                                            <Link :href="`/lecturer/exams/${exam.id}/questions/${question.id}/edit`" class="btn btn-sm btn-info border-0 shadow me-2"
...
<script>
    //import layout
    import LayoutLecturer from '../../../Layouts/Lecturer.vue';
            ...
            const destroy = (exam_id, question_id) => {
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        router.delete(`/lecturer/exams/${exam_id}/questions/${question_id}/destroy`);
