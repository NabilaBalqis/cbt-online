            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-3 col-12 mb-2">
                        <Link href="/lecturer/exams/create" class="btn btn-md btn-primary border-0 shadow w-100" type="button"><i
                                ...
                                <tbody>
                                    <tr v-for="(exam, index) in exams.data" :key="index">
                                        ...
                                        <td class="text-center">
                                            <Link :href="`/lecturer/exams/${exam.id}`" class="btn btn-sm btn-primary border-0 shadow me-2" type="button"><i class="fa fa-plus-circle"></i></Link>
                                            <Link :href="`/lecturer/exams/${exam.id}/edit`" class="btn btn-sm btn-info border-0 shadow me-2" type="button"><i class="fa fa-pencil-alt"></i></Link>
            ...
            const destroy = (id) => {
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        router.delete(`/lecturer/exams/${id}`);
