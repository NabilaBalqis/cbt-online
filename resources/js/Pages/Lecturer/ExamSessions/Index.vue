            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-3 col-12 mb-2">
                        <Link href="/lecturer/exam_sessions/create" class="btn btn-md btn-primary border-0 shadow w-100" type="button"><i
                                ...
                                <tbody>
                                    <tr v-for="(exam_session, index) in exam_sessions.data" :key="index">
                                        ...
                                        <td class="text-center">
                                            <Link :href="`/lecturer/exam_sessions/${exam_session.id}`" class="btn btn-sm btn-primary border-0 shadow me-2" type="button"><i class="fa fa-plus-circle"></i></Link>
                                            <Link :href="`/lecturer/exam_sessions/${exam_session.id}/edit`" class="btn btn-sm btn-info border-0 shadow me-2" type="button"><i class="fa fa-pencil-alt"></i></Link>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const handleSearch = () => {
                router.get('/lecturer/exam_sessions', {
            ...
            const destroy = (id) => {
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        router.delete(`/lecturer/exam_sessions/${id}`);
