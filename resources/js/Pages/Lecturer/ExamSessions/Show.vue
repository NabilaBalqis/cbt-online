    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <Link href="/lecturer/exam_sessions" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        ...
                        <Link :href="`/lecturer/exam_sessions/${exam_session.id}/enrolle/create`" class="btn btn-md btn-primary border-0 shadow me-2" type="button"><i class="fa fa-user-plus"></i> Enrolle Siswa</Link>
            ...
            const destroy = (exam_session_id, exam_group_id) => {
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        router.delete(`/lecturer/exam_sessions/${exam_session_id}/enrolle/${exam_group_id}/destroy`);
