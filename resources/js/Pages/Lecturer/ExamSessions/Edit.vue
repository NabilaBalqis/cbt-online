<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link href="/lecturer/exam_sessions" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                //send data to server
                router.put(`/lecturer/exam_sessions/${props.exam_session.id}`, {
                    //data
                    title: form.title,
