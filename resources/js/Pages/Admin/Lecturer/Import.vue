<template>
    <Head>
        <title>Import Dosen - Aplikasi Ujian Online</title>
    </Head>
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link href="/admin/lecturer" class="btn btn-md btn-primary border-0 shadow mb-3 me-3" type="button"><i
                    class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
                <a href="/assets/excel/lecturer.xls" target="_blank"
    ...
    export default {
        ...
        setup() {
            ...
            const submit = () => {
                ...
                //send data to server
                router.post('/admin/lecturer/import', {
                    //data
                    file: form.file,
                }, {
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Import Dosen Berhasil Disimpan!.',
                            icon: 'success',
